...
public class TodoController {
    ...
    @Operation(summary = "Get all todo for user", description = "Get all todo from the signed in user")
    ...
    @Operation(summary = "Create todo for user", description = "Created todo for the signed in user")
